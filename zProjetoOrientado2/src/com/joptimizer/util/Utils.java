...
public class Utils {
	...
	public static double RELATIVE_MACHINE_PRECISION = Double.NaN;
...
//	}
	 ...
	 */
	public static final double calculateDoubleMachineEpsilon() {
		double eps = 1.;
		do {
			eps /= 2.;
