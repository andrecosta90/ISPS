...
public class NewtonLEConstrainedFSP extends OptimizationRequestHandler {
	...
	public int optimize() throws Exception {
		...
		if (X0 == null	|| (getA()!=null && Math.abs(ALG.norm2(getA().zMult(X0, getB().copy(), 1., -1., false))) > Utils.RELATIVE_MACHINE_PRECISION)) {	
...
//			previousF0X = F0X;
			...
			if(gradXNorm < Utils.RELATIVE_MACHINE_PRECISION){
				response.setReturnCode(OptimizationResponse.SUCCESS);
				break;
			}
